...
return [
    ...
    "budgets_title" => "Devis",
    "budget" => "Devis",
    "budget_registration" => "Enregistrement de Devis",
    ...
    "value_label" => "Valeur (USD) :",
    "select_option" => "Sélectionnez...",
    "no_addresses_found" => "Aucune adresse enregistrée.",
    "register_budget_btn" => "Enregistrer le Devis",
    "registered_budgets_list" => "Devis Enregistrés",
    "header_company" => "Entreprise",
    "header_vehicle" => "Véhicule",
    "header_origin" => "Origine",
    "header_destination" => "Destination",
    "header_start_date" => "Date Début",
    "header_end_date" => "Date Fin",
    "header_value" => "Valeur",
    "confirm_delete_budget" => "Supprimer ce devis ?",
