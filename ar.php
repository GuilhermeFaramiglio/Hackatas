...
return [
    ...
    "budget" => "ميزانية",
    "budget_registration" => "تسجيل الميزانية",
    ...
    "value_label" => "القيمة (USD):",
    "select_option" => "اختر...",
    "no_addresses_found" => "لا توجد عناوين مسجلة.",
    "register_budget_btn" => "تسجيل الميزانية",
    "registered_budgets_list" => "الميزانيات المسجلة",
    "header_company" => "الشركة",
    "header_vehicle" => "المركبة",
    "header_origin" => "المنشأ",
    "header_destination" => "الوجهة",
    "header_start_date" => "تاريخ البدء",
    "header_end_date" => "تاريخ الانتهاء",
    "header_value" => "القيمة",
    "confirm_delete_budget" => "حذف هذه الميزانية؟",
